...
export const staticDocsData: SearchResult[] = [
  {
    ...
    url: '/docs',
    slug: '',
    content: 'PenquinX bug hunting toolkit automation efficiency philosophy transformation consequences warnings repetitive automate simplify eliminate precision subdomains terminal tools chains triage bounties Netflix confidence dependency clean execution purists romanticize pain inefficiency authentic progress stagnation',
    description: 'Getting started with PenquinX'
  },
  {
    title: 'Arsenal',
    url: '/docs/arsenal',
